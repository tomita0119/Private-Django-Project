...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceUserView'
        db.create_table(u'surm_resourceuserview', (
        ...
        db.send_create_signal(u'surm', ['ResourceUserView'])


    def backwards(self, orm):
        # Deleting model 'ResourceUserView'
        db.delete_table(u'surm_resourceuserview')
