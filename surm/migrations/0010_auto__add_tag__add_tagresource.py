...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'surm', ['Tag'])

        # Adding model 'TagResource'
        db.create_table(u'surm_tagresource', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surm.Group'])),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surm.Resource'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surm.Tag'])),
        ))
        db.send_create_signal(u'surm', ['TagResource'])


    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'surm_tag')

        # Deleting model 'TagResource'
        db.delete_table(u'surm_tagresource')
