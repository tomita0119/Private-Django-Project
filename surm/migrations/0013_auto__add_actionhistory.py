...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ActionHistory'
        db.create_table(u'surm_actionhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surm.Group'])),
            ('acted', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('kind', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['surm.Resource'], null=True, blank=True)),
        ))
        db.send_create_signal(u'surm', ['ActionHistory'])


    def backwards(self, orm):
        # Deleting model 'ActionHistory'
        db.delete_table(u'surm_actionhistory')
