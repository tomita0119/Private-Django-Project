...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceUserFavorite.favorited'
        db.add_column(u'surm_resourceuserfavorite', 'favorited',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 12, 11, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceUserFavorite.favorited'
        db.delete_column(u'surm_resourceuserfavorite', 'favorited')
